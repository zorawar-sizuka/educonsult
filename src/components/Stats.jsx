...
//               <RevealText>
//                 <span className="flex items-center gap-3 text-xs font-bold tracking-[0.2em] text-[#f16825] uppercase mb-3 lg:mb-4">
//                   <span className="h-0.5 w-8 bg-[#f16825] rounded-full flex-shrink-0" />
//                   About Us
//                 </span>
//               </RevealText>

//               <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-light tracking-tighter text-[#3a56a4] leading-[0.95]">
//                 <RevealText delay={0.1}>
//                   The <span className="font-serif italic text-[#f36627]/80">Scholar</span>
//                 </RevealText>
...
//             >
//               <div className="
//                 text-3xl sm:text-4xl md:text-6xl lg:text-7xl font-serif text-[#0c38b0] 
...
//                 <span className="text-xl sm:text-2xl lg:text-4xl text-[#f06623] font-sans font-light">{stat.suffix}</span>
//               </div>
