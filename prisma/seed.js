...
// // prisma/seed.js — add this at the very top
// await prisma.university.deleteMany({}); // <-- Deletes ALL existing universities
...
async function seedCountries() {
  console.log("🌱 Seeding 7 core countries with realistic living costs...");

  const countries = [
    { code: "USA", name: "United States", currencyCode: "USD", livingCostMonthlyUsd: 1800, tutionCostMonthlyUsd: 17500 },
    { code: "GBR", name: "United Kingdom", currencyCode: "GBP", livingCostMonthlyUsd: 1500, tutionCostMonthlyUsd: 14000 },
    { code: "AUS", name: "Australia", currencyCode: "AUD", livingCostMonthlyUsd: 1700, tutionCostMonthlyUsd: 13500 },
    { code: "CAN", name: "Canada", currencyCode: "CAD", livingCostMonthlyUsd: 1400, tutionCostMonthlyUsd: 11000 },
    { code: "DEU", name: "Germany", currencyCode: "EUR", livingCostMonthlyUsd: 1000, tutionCostMonthlyUsd: 2000 },
    { code: "JPN", name: "Japan", currencyCode: "JPY", livingCostMonthlyUsd: 1200, tutionCostMonthlyUsd: 6005 },
  ...
  for (const c of countries) {
    try {
      ...
      console.warn(`⚠️ Skip country ${c.code}: ${e.message}`);
    }
  }

  console.log(`✅ Seeded/Updated ${seeded} countries.`);
}

async function seedUniversities() {
  console.log("🌱 Seeding 50+ universities with consistent schema...");
  ...
  const universities = [
    ...
    // Germany (8 – Tuition-Free + Realistic Admin Fees)
    {
      name: "Technical University of Munich",
      countryCode: "DEU",
      city: "Munich",
  ...
  // Optional: Uncomment ONLY for full reset (dev only!)
  // await prisma.university.deleteMany({});
  // console.log("Cleared all existing universities");
    ...
    try {
      await prisma.university.upsert({
        ...
        update: {
          ...
          livingCostYearUsd: uni.livingCostYearUsd,
          adminFeeUsd: uni.adminFeeUsd,
          intake: uni.intake,
          applicationFeeUsd: uni.applicationFeeUsd,
          website: uni.website,
          tags: uni.tags,
        },
        create: uni,
      ...
      console.warn(`⚠️ Skipped ${uni.name} (${uni.countryCode}): ${e.message}`);
      skippedCount++;
    }
  }
  ...
  console.log(
    `✅ Seeded/Updated ${seededCount} universities. Skipped: ${skippedCount}. Total in DB: ${total}`
  );
}

async function main() {
  console.log("🌱 Starting focused seed for 7 countries + 50+ universities...");
